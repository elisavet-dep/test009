...
Синтаксис - ** ** и _ _
Пример - **This text is _ extremely _important**
...
Цитировать текст можно с помощью стрелки вправо >.
...
В сообщениях о проблемах, запросах на вытягивание и обсуждениях можно вызывать цвета в предложении, используя обратные кавычки. Поддерживаемая цветовая модель, 
заключенная в обратные кавычки, будет отображать визуализацию цвета.
...
A footnote can also have multiple lines[^2]. [^1]: My reference.
